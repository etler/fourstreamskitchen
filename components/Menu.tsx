...
const dinnerSections: MenuSectionProps[] = [
  {
    title: "Appetizers",
    items: [
      { name: "Steamed Bun", price: 9 },
      { name: "Steamed Dumplings (6)", price: 9 },
      { name: "Fried Wonton Chips  (10)", price: 8 },
      ...
      { name: "Garlic Chicken Wing (6)", price: 10.5 },
      { name: "Red Oil Wonton", price: 9.5 },
    ],
  },
  {
    title: "Soup",
    items: [
      ...
      {
        name: "Pork with Szechuan Pickle Soup",
        type: "size",
        price: { small: 9.5, large: 13.5 },
      },
      { name: "Spinach Tofu Soup", type: "size", price: { small: 9, large: 13 } },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Honey Walnut Prawns", price: 17.5 },
      {
      ...
      { name: "Szechuan Boiled Fish", price: 18, spiciness: 2 },
      { name: "Oil Splashed Fish Fillet", price: 17, spiciness: 1 },
    ],
  },
  {
    title: "Pork",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Crispy Duck (half)", price: 19.5 },
    ],
  },
  {
    title: "Egg Foo Yang",
    items: [
      { name: "Veggie Egg Foo Yang", price: 13.5 },
      { name: "Chicken Egg Foo Yang", price: 13.5 },
      { name: "BBQ Pork Egg Foo Yang", price: 13.5 },
      { name: "Shrimp Egg Foo Yang", price: 13.5 },
    ],
  },
  {
    title: "Vegetables",
    items: [
      { name: "Four Streams Tofu", price: 13.5 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Chow Mein", price: 11.5 },
      { name: "Beef Chow Mein", price: 12.5 },
      { name: "Pork Chow Mein", price: 11.5 },
      ...
      { name: "Singapore Fried Rice Noodles", price: 15.5 },
    ],
  },
  {
    title: "Chow Fun",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Chicken Fried Rice", price: 11.5 },
      { name: "Beef Fried Rice", price: 12.5 },
      { name: "Pork Fried Rice", price: 11.5 },
...
const lunchSections: MenuSectionProps[] = [
  {
    title: "Specials",
    items: [
      { name: "Garlic Green Bean", price: 11.25 },
      { name: "Mixed Vegetable", price: 11.25 },
      { name: "Broccoli with Cashew", price: 11.25 },
      { name: "Sweet & Sour Pork (or Chicken)", price: 12.25 },
      { name: "Broccoli Beef", price: 12.25 },
      { name: "Broccoli Chicken In Spicy Garlic", price: 12.25, spiciness: 1 },
      { name: "Cashew Chicken or Almond Chicken", price: 12.25 },
      { name: "Beef with Vegetables", price: 12.25 },
      { name: "Black Bean Sauce Chicken", price: 12.25 },
      { name: "Double Mushroom Chicken", price: 12.25 },
      { name: "Curry Chicken", price: 12.25 },
      { name: "Mongolian Beef", price: 12.75, spiciness: 1 },
      { name: "Sesame Chicken", price: 12.75 },
      { name: "Kung Pao Tofu", price: 12.75, spiciness: 1 },
      { name: "Kung Pao Chicken", price: 12.75, spiciness: 1 },
      { name: "Szechuan Beef", price: 12.75, spiciness: 1 },
      { name: "Chicken with Assorted Vegetables", price: 12.75 },
      { name: "Lemon Chicken", price: 12.75 },
      { name: "Twice Cooked Pork", price: 12.75, spiciness: 1 },
      { name: "Black Bean Sauce Prawns", price: 14.75 },
      { name: "Kung Pao Prawns", price: 14.75, spiciness: 1 },
      { name: "Shrimp with Assorted Vegetables", price: 14.75 },
      { name: "Szechuan Prawns", price: 14.75, spiciness: 1 },
      { name: "Broccoli Shrimp", price: 14.75 },
      { name: "Sweet & Sour Prawns", price: 14.75 },
  ...
  },
  {
    items: [
      ...
      { name: "Pan Fried Noodle Hong Kong Style", price: 16.5 },
    ],
